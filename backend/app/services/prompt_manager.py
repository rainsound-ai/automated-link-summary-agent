...
class PromptManager:
    ...
    def get_available_users(self) -> List[str]:
        ...
        return [d for d in os.listdir(self.prompts_dir) 
                if os.path.isdir(os.path.join(self.prompts_dir, d))]
    
    def get_prompt_for_user(self, user: str, is_llm_conversation: bool, is_jumpshare_link: bool) -> str:
    ...
    def get_eval_prompt_for_user(self, user: str, is_llm_conversation: bool, is_jumpshare_link: bool) -> str:
